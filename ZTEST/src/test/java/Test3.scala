...
object Test3 {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val messages = Array(
      TaskDesc(0, TaskType.ASSIGN, Array("taskType=SPARK", "class=youe.data.scala.drivers.EtlDriver2", "function=etl_read_csv", "inputpath=data/input/data2", "outputpath=data/output/1-2"), 1, 2),
      TaskDesc(0, TaskType.ASSIGN, Array("taskType=SPARK", "class=youe.data.scala.drivers.EtlDriver2", "function=etl_binary_split", "splitType=0","splitValue=0.5","inputpath=data/input/input1", "outputpath1=data/output/2-out1","outputpath2=data/output/2-out2"), 2, 3),
      TaskDesc(0, TaskType.ASSIGN, Array("taskType=SPARK", "class=youe.data.scala.drivers.EtlDriver2", "function=etl_binary_split", "splitType=0","splitValue=0.5", "inputpath=data/input/input1", "outputpath1=data/output/2-out1","outputpath2=data/output/2-out2"), 2, 4),
